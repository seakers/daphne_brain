...
class GaContainerClient(AbstractContainerClient):
    def __init__(self, user_info, container=None):
        ...
        self.ga_eval_response_queue = None
    ...
    def start_algorithm(self, objectives, max_evals=1000):
        msg_attributes = {
            'msgType': {
            ...
            'dataset_id': {
                'StringValue': str(self.user_info.eosscontext.dataset_id),
                'DataType': 'String'
            },
            'maxEvals': {
                'StringValue': str(max_evals),
                'DataType': 'String'
            },
            'problem_id': {
            ...
            'VASSAR_REQUEST_QUEUE': {
                'StringValue': str(self.eval_request_queue),
                'DataType': 'String'
            },
            'VASSAR_RESPONSE_QUEUE': {
                'StringValue': str(self.eval_response_queue),
                'DataType': 'String'
            },
        }
