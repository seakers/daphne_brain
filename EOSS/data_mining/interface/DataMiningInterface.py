...
class Iface(object):
    ...
    def getDrivingFeaturesEpsilonMOEABinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
        """
        Parameters:
         - session
         - problem_id
    ...
    def getDrivingFeaturesEpsilonMOEADiscrete(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
        """
        Parameters:
         - session
         - problem_id
    ...
    def generalizeFeatureBinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs, rootfeatureExpression, nodeFeatureExpression):
        """
        Parameters:
         - session
         - problem_id
    ...
    def getDrivingFeaturesWithGeneralizationBinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
        """
        Parameters:
         - session
         - problem_id
    ...
    def simplifyFeatureExpression(self, session, problem_id, problem_type, expression):
        """
        Parameters:
         - session
         - problem_id
    ...
    def setAssigningProblemEntities(self, session, problem_id, entities):
        """
        Parameters:
         - session
         - problem_id
    ...
    def setAssigningProblemGeneralizedConcepts(self, session, problem_id, generalizedConcepts):
        """
        Parameters:
         - session
         - problem_id
    ...
    def getAssigningProblemConceptHierarchy(self, session, problem_id, params):
        """
        Parameters:
         - session
         - problem_id
...
class Client(Iface):
    ...
    def getDrivingFeaturesEpsilonMOEABinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
        ...
        """
        self.send_getDrivingFeaturesEpsilonMOEABinary(session, problem_id, problem_type, behavioral, non_behavioral, all_archs)
        return self.recv_getDrivingFeaturesEpsilonMOEABinary()

    def send_getDrivingFeaturesEpsilonMOEABinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
    ...
    def getDrivingFeaturesEpsilonMOEADiscrete(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
        ...
        """
        self.send_getDrivingFeaturesEpsilonMOEADiscrete(session, problem_id, problem_type, behavioral, non_behavioral, all_archs)
        return self.recv_getDrivingFeaturesEpsilonMOEADiscrete()

    def send_getDrivingFeaturesEpsilonMOEADiscrete(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
    ...
    def generalizeFeatureBinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs, rootfeatureExpression, nodeFeatureExpression):
        ...
        """
        self.send_generalizeFeatureBinary(session, problem_id, problem_type, behavioral, non_behavioral, all_archs, rootfeatureExpression, nodeFeatureExpression)
        return self.recv_generalizeFeatureBinary()

    def send_generalizeFeatureBinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs, rootfeatureExpression, nodeFeatureExpression):
    ...
    def getDrivingFeaturesWithGeneralizationBinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
        ...
        """
        self.send_getDrivingFeaturesWithGeneralizationBinary(session, problem_id, problem_type, behavioral, non_behavioral, all_archs)
        return self.recv_getDrivingFeaturesWithGeneralizationBinary()

    def send_getDrivingFeaturesWithGeneralizationBinary(self, session, problem_id, problem_type, behavioral, non_behavioral, all_archs):
    ...
    def simplifyFeatureExpression(self, session, problem_id, problem_type, expression):
        ...
        """
        self.send_simplifyFeatureExpression(session, problem_id, problem_type, expression)
        return self.recv_simplifyFeatureExpression()

    def send_simplifyFeatureExpression(self, session, problem_id, problem_type, expression):
    ...
    def setAssigningProblemEntities(self, session, problem_id, entities):
        ...
        """
        self.send_setAssigningProblemEntities(session, problem_id, entities)
        return self.recv_setAssigningProblemEntities()

    def send_setAssigningProblemEntities(self, session, problem_id, entities):
    ...
    def setAssigningProblemGeneralizedConcepts(self, session, problem_id, generalizedConcepts):
        ...
        """
        self.send_setAssigningProblemGeneralizedConcepts(session, problem_id, generalizedConcepts)
        return self.recv_setAssigningProblemGeneralizedConcepts()

    def send_setAssigningProblemGeneralizedConcepts(self, session, problem_id, generalizedConcepts):
    ...
    def getAssigningProblemConceptHierarchy(self, session, problem_id, params):
        ...
        """
        self.send_getAssigningProblemConceptHierarchy(session, problem_id, params)
        return self.recv_getAssigningProblemConceptHierarchy()

    def send_getAssigningProblemConceptHierarchy(self, session, problem_id, params):
...
class Processor(Iface, TProcessor):
    ...
    def process_getDrivingFeaturesEpsilonMOEABinary(self, seqid, iprot, oprot):
        ...
        result = getDrivingFeaturesEpsilonMOEABinary_result()
        try:
            result.success = self._handler.getDrivingFeaturesEpsilonMOEABinary(args.session, args.problem_id, args.problem_type, args.behavioral, args.non_behavioral, args.all_archs)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_getDrivingFeaturesEpsilonMOEADiscrete(self, seqid, iprot, oprot):
        ...
        result = getDrivingFeaturesEpsilonMOEADiscrete_result()
        try:
            result.success = self._handler.getDrivingFeaturesEpsilonMOEADiscrete(args.session, args.problem_id, args.problem_type, args.behavioral, args.non_behavioral, args.all_archs)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_generalizeFeatureBinary(self, seqid, iprot, oprot):
        ...
        result = generalizeFeatureBinary_result()
        try:
            result.success = self._handler.generalizeFeatureBinary(args.session, args.problem_id, args.problem_type, args.behavioral, args.non_behavioral, args.all_archs, args.rootfeatureExpression, args.nodeFeatureExpression)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_getDrivingFeaturesWithGeneralizationBinary(self, seqid, iprot, oprot):
        ...
        result = getDrivingFeaturesWithGeneralizationBinary_result()
        try:
            result.success = self._handler.getDrivingFeaturesWithGeneralizationBinary(args.session, args.problem_id, args.problem_type, args.behavioral, args.non_behavioral, args.all_archs)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_simplifyFeatureExpression(self, seqid, iprot, oprot):
        ...
        result = simplifyFeatureExpression_result()
        try:
            result.success = self._handler.simplifyFeatureExpression(args.session, args.problem_id, args.problem_type, args.expression)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_setAssigningProblemEntities(self, seqid, iprot, oprot):
        ...
        result = setAssigningProblemEntities_result()
        try:
            result.success = self._handler.setAssigningProblemEntities(args.session, args.problem_id, args.entities)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_setAssigningProblemGeneralizedConcepts(self, seqid, iprot, oprot):
        ...
        result = setAssigningProblemGeneralizedConcepts_result()
        try:
            result.success = self._handler.setAssigningProblemGeneralizedConcepts(args.session, args.problem_id, args.generalizedConcepts)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_getAssigningProblemConceptHierarchy(self, seqid, iprot, oprot):
        ...
        result = getAssigningProblemConceptHierarchy_result()
        try:
            result.success = self._handler.getAssigningProblemConceptHierarchy(args.session, args.problem_id, args.params)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class getDrivingFeaturesEpsilonMOEABinary_args(object):
    ...
    def __init__(self, session=None, problem_id=None, problem_type=None, behavioral=None, non_behavioral=None, all_archs=None,):
        self.session = session
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.problem_id = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.problem_type = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
    ...
    def write(self, oprot):
        ...
        if self.problem_id is not None:
            oprot.writeFieldBegin('problem_id', TType.I32, 2)
            oprot.writeI32(self.problem_id)
            oprot.writeFieldEnd()
        if self.problem_type is not None:
            oprot.writeFieldBegin('problem_type', TType.STRING, 3)
            oprot.writeString(self.problem_type.encode('utf-8') if sys.version_info[0] == 2 else self.problem_type)
            oprot.writeFieldEnd()
        if self.behavioral is not None:
            oprot.writeFieldBegin('behavioral', TType.LIST, 4)
            oprot.writeListBegin(TType.I32, len(self.behavioral))
            ...
            oprot.writeFieldEnd()
        if self.non_behavioral is not None:
            oprot.writeFieldBegin('non_behavioral', TType.LIST, 5)
            oprot.writeListBegin(TType.I32, len(self.non_behavioral))
            ...
            oprot.writeFieldEnd()
        if self.all_archs is not None:
            oprot.writeFieldBegin('all_archs', TType.LIST, 6)
            oprot.writeListBegin(TType.STRUCT, len(self.all_archs))
...
getDrivingFeaturesEpsilonMOEABinary_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'session', 'UTF8', None, ),  # 1
    (2, TType.I32, 'problem_id', None, None, ),  # 2
    (3, TType.STRING, 'problem_type', 'UTF8', None, ),  # 3
    (4, TType.LIST, 'behavioral', (TType.I32, None, False), None, ),  # 4
    (5, TType.LIST, 'non_behavioral', (TType.I32, None, False), None, ),  # 5
    (6, TType.LIST, 'all_archs', (TType.STRUCT, [BinaryInputArchitecture, None], False), None, ),  # 6
)
...
getDrivingFeaturesEpsilonMOEADiscrete_args.thrift_spec = (
    ...
    (4, TType.LIST, 'behavioral', (TType.I32, None, False), None, ),  # 4
    (5, TType.LIST, 'non_behavioral', (TType.I32, None, False), None, ),  # 5
    (6, TType.LIST, 'all_archs', (TType.STRUCT, [DiscreteInputArchitecture, None], False), None, ),  # 6
)
...
class generalizeFeatureBinary_args(object):
    ...
    def __init__(self, session=None, problem_id=None, problem_type=None, behavioral=None, non_behavioral=None, all_archs=None, rootfeatureExpression=None, nodeFeatureExpression=None,):
        self.session = session
        self.problem_id = problem_id
        self.problem_type = problem_type
        self.behavioral = behavioral
    ...
    def write(self, oprot):
        ...
        if self.rootfeatureExpression is not None:
            oprot.writeFieldBegin('rootfeatureExpression', TType.STRING, 7)
        ...
        if self.nodeFeatureExpression is not None:
            oprot.writeFieldBegin('nodeFeatureExpression', TType.STRING, 8)
...
generalizeFeatureBinary_args.thrift_spec = (
    ...
    (5, TType.LIST, 'non_behavioral', (TType.I32, None, False), None, ),  # 5
    (6, TType.LIST, 'all_archs', (TType.STRUCT, [BinaryInputArchitecture, None], False), None, ),  # 6
    (7, TType.STRING, 'rootfeatureExpression', 'UTF8', None, ),  # 7
    (8, TType.STRING, 'nodeFeatureExpression', 'UTF8', None, ),  # 8
)
...
class simplifyFeatureExpression_args(object):
    ...
    def __init__(self, session=None, problem_id=None, problem_type=None, expression=None,):
        self.session = session
        self.problem_id = problem_id
        self.problem_type = problem_type
    ...
    def write(self, oprot):
        ...
        if self.expression is not None:
            oprot.writeFieldBegin('expression', TType.STRING, 4)
...
simplifyFeatureExpression_args.thrift_spec = (
    ...
    (2, TType.I32, 'problem_id', None, None, ),  # 2
    (3, TType.STRING, 'problem_type', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'expression', 'UTF8', None, ),  # 4
)
...
class setAssigningProblemEntities_args(object):
    ...
    def __init__(self, session=None, problem_id=None, entities=None,):
        self.session = session
        self.problem_id = problem_id
...
class setAssigningProblemGeneralizedConcepts_args(object):
    ...
    def __init__(self, session=None, problem_id=None, generalizedConcepts=None,):
        self.session = session
        self.problem_id = problem_id
...
class getAssigningProblemConceptHierarchy_args(object):
    ...
    def __init__(self, session=None, problem_id=None, params=None,):
        self.session = session
        self.problem_id = problem_id
        self.params = params
