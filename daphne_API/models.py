...
class EOSSContext(models.Model):
    ...
    # Subcontexts related to EOSS
    active_context = models.OneToOneField(ActiveContext, on_delete=models.CASCADE)
    engineer_context = models.OneToOneField(EngineerContext, on_delete=models.CASCADE)
...
class UserInformation(models.Model):
    ...
    # Contexts for each version
    eoss_context = models.OneToOneField(EOSSContext, on_delete=models.CASCADE)
