...
# Simulator variables
add_variable('cabin_pressure', 0.5, 0.9, 1, 1.1, 1.5)
add_variable('n2_concentration', 60, 70, 79, 85, 90)
add_variable('dummy', 150, 180, 200, 220, 250)

# Simulator anomaly settings
add_to_anomaly('n2_tank_burst', 'n2_concentration', 0.1, -0.1, 1)
add_to_anomaly('n2_tank_burst', 'cabin_pressure', 0.02, -0.02, 0.5)
