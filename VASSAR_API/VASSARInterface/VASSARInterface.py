...
class getScoreExplanation_result(object):
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (TType.STRUCT, (ObjectiveSatisfaction, ObjectiveSatisfaction.thrift_spec), False), None, ),  # 0
    )
