            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i115 in range(_size111):
                        _elem116 = BinaryInputArchitecture()
                        _elem116.read(iprot)
...
class getArchitectureScoreExplanation_args(object):
    ...
    def write(self, oprot):
        ...
        if self.arch is not None:
            ...
            for iter173 in self.arch:
                oprot.writeBool(iter173)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i178 in range(_size174):
                        _elem179 = ObjectiveSatisfaction()
                        _elem179.read(iprot)
...
class getPanelScoreExplanation_args(object):
    ...
    def write(self, oprot):
        ...
        if self.arch is not None:
            oprot.writeFieldBegin('arch', TType.LIST, 1)
            oprot.writeListBegin(TType.BOOL, len(self.arch))
            for iter187 in self.arch:
                oprot.writeBool(iter187)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.panel is not None:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i192 in range(_size188):
                        _elem193 = ObjectiveSatisfaction()
                        _elem193.read(iprot)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i213 in range(_size209):
                        _elem214 = BinaryInputArchitecture()
                        _elem214.read(iprot)
                        self.dataset.append(_elem214)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i227 in range(_size223):
                        _elem228 = MissionCostInformation()
                        _elem228.read(iprot)
