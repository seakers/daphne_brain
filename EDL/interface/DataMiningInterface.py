...
class Iface(object):
    ...
    def getDrivingFeaturesEpsilonMOEABinaryEDL(self, session, problem, file_path, class_val, no_params):
        """
        Parameters:
         - session
         - problem
...
class Client(Iface):
    ...
    def getDrivingFeaturesEpsilonMOEABinaryEDL(self, session, problem, file_path, class_val, no_params):
        ...
        """
        self.send_getDrivingFeaturesEpsilonMOEABinaryEDL(session, problem, file_path, class_val, no_params)
        return self.recv_getDrivingFeaturesEpsilonMOEABinaryEDL()

    def send_getDrivingFeaturesEpsilonMOEABinaryEDL(self, session, problem, file_path, class_val, no_params):
        self._oprot.writeMessageBegin('getDrivingFeaturesEpsilonMOEABinaryEDL', TMessageType.CALL, self._seqid)
        args = getDrivingFeaturesEpsilonMOEABinaryEDL_args()
        args.session = session
        args.problem = problem
        args.file_path = file_path
        args.class_val = class_val
        args.no_params = no_params
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_getDrivingFeaturesEpsilonMOEABinaryEDL(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = getDrivingFeaturesEpsilonMOEABinaryEDL_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getDrivingFeaturesEpsilonMOEABinaryEDL failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getDrivingFeaturesEpsilonMOEABinaryEDL"] = Processor.process_getDrivingFeaturesEpsilonMOEABinaryEDL
    ...
    def process_getDrivingFeaturesEpsilonMOEABinaryEDL(self, seqid, iprot, oprot):
        args = getDrivingFeaturesEpsilonMOEABinaryEDL_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getDrivingFeaturesEpsilonMOEABinaryEDL_result()
        try:
            result.success = self._handler.getDrivingFeaturesEpsilonMOEABinaryEDL(args.session, args.problem, args.file_path, args.class_val, args.no_params)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getDrivingFeaturesEpsilonMOEABinaryEDL", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class getDrivingFeaturesEpsilonMOEABinaryEDL_args(object):
    """
    Attributes:
     - session
     - problem
    ...
    def __init__(self, session=None, problem=None, file_path=None, class_val=None, no_params=None,):
        self.session = session
        self.problem = problem
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.class_val = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.I32:
                    self.no_params = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getDrivingFeaturesEpsilonMOEABinaryEDL_args')
        if self.session is not None:
            oprot.writeFieldBegin('session', TType.STRING, 1)
            oprot.writeString(self.session.encode('utf-8') if sys.version_info[0] == 2 else self.session)
            oprot.writeFieldEnd()
        ...
        if self.class_val is not None:
            oprot.writeFieldBegin('class_val', TType.I32, 4)
            oprot.writeI32(self.class_val)
            oprot.writeFieldEnd()
        if self.no_params is not None:
            oprot.writeFieldBegin('no_params', TType.I32, 5)
            oprot.writeI32(self.no_params)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getDrivingFeaturesEpsilonMOEABinaryEDL_args)
getDrivingFeaturesEpsilonMOEABinaryEDL_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'session', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'problem', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'file_path', 'UTF8', None, ),  # 3
    (4, TType.I32, 'class_val', None, None, ),  # 4
    (5, TType.I32, 'no_params', None, None, ),  # 5
)


class getDrivingFeaturesEpsilonMOEABinaryEDL_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getDrivingFeaturesEpsilonMOEABinaryEDL_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getDrivingFeaturesEpsilonMOEABinaryEDL_result)
getDrivingFeaturesEpsilonMOEABinaryEDL_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [Feature, None], False), None, ),  # 0
)
...
class getDrivingFeaturesWithGeneralizationBinary_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i358 in range(_size354):
                        ...
                        self.behavioral.append(_elem359)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.LIST:
                    ...
                    for _i364 in range(_size360):
                        ...
                        self.non_behavioral.append(_elem365)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.LIST:
                    ...
                    for _i370 in range(_size366):
                        _elem371 = BinaryInputArchitecture()
                        _elem371.read(iprot)
                        self.all_archs.append(_elem371)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.behavioral is not None:
            oprot.writeFieldBegin('behavioral', TType.LIST, 3)
            oprot.writeListBegin(TType.I32, len(self.behavioral))
            for iter372 in self.behavioral:
                oprot.writeI32(iter372)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.non_behavioral is not None:
            oprot.writeFieldBegin('non_behavioral', TType.LIST, 4)
            oprot.writeListBegin(TType.I32, len(self.non_behavioral))
            for iter373 in self.non_behavioral:
...
class computeComplexityOfFeatures_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i386 in range(_size382):
                        ...
                        self.expressions.append(_elem387)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.expressions is not None:
            ...
            for iter388 in self.expressions:
