...
def error_answers(objective, missing_param):
    return {
        'voice_answer': 'I interpreted that you are trying to ' + objective + '. I can\'t do this because I\'m missing '
                        'a ' + missing_param + ' parameter. If you think I\'m not doing the correct thing, please '
                        'report this to someone.',
        'visual_answer_type': ['text'],
        'visual_answer': ['I interpreted that you are trying to ' + objective + '. I can\'t do this because I\'m missing '
                          'a ' + missing_param + ' parameter. If you think I\'m not doing the correct thing, please '
                          'report this to someone.']
    }
